...
<html>
<head>
	<title>Project_calendar</title>
	<link rel="stylesheet" href="assets/css/Pcale.css">
						...
						$("#mission_dialog").dialog({
					        ...
					        buttons: [
						        ...
						        },
						        {
								    ...
								    click: function() {
								        document.location.href="PEventC.php?sel=0&id="+mission_id;
								    }
						        }
						    ],
							open: function(){
							        ...
							        buttons: [
								        {
								            ...
								            "class": 'EditButtonClass',
								            click: function() {
								        		document.location.href="PEventC.php?sel=1&date="+fullDate;
								            }
								        },
								        {
								            text: "Create",
...
<body onload="init()">
<div class="top">
		<img class="icon" src="assets/images/Picon/Piconb-cale.png">
		<h2 class="pagetitle">專案行事曆</h2>
</div>
