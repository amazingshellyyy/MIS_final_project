...
$sel = $_GET["sel"];
	...
	<head>
		...
		<link rel="stylesheet" href="PerEventC.css">
	...
	<body>
		<div class="content">
			<div class="head">   
				<img src="assets/images/Event.png" class="icon">
				...
				<tbody>
					<form method="POST" action="editEventFunction.php">
						<tr class="PS-1">
							...
							<td class="PS1-2"><input type="text" name="title" value=<?php echo $result["title"]?>></td>

						</tr>
						<tr class="PS-1">
							<td class="PS1-1">地點</td>
							<td class="PS1-2"  type="text" name="palce" value=<?php //no place?>><input type="text" name=""></td>
							...
							<tr class="PS-1">
								...
								<td class="PS1-2">
									...
									<input class="EventTime"  type="text" id="from" name="from" value=<?php echo $result["date"] //有開始沒結束?>>
									<div  class="EventTime" for="to">到</div>
									<input class="EventTime"  type="text" id="to" name="to">
								</td>
							</tr>
							<tr class="PS-1">
