<?php
 ...
 // 	}
	...
	for($i=1;$i<=$limit;$i++){
		...
		$sql = "SELECT title,id,date,(SELECT COUNT(*) FROM events where date='$now_month-$i' and userId='$userRow[0]')as c from events where date='$now_month-$i' and userId='$userRow[0]'"; //id寫死從前面傳
